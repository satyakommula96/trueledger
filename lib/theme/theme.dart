...
class AppTheme {
  ...
  static ThemeData get darkTheme => ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      elevation: 0,
      centerTitle: false,
      titleTextStyle: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Color(0xFFE5E7EB)),
  ...
  static ThemeData get lightTheme => ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      elevation: 0,
      centerTitle: false,
      titleTextStyle: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Color(0xFF1F2933)),
