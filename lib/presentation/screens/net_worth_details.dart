            ...
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                return _buildListItem(
                  l.name,
                  CurrencyHelper.format(l.remainingAmount, compact: false),
                  l.loanType,
                  semantic.overspent,
                );
              },
          ...
          sliver: SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                return _buildListItem(
                  c.bank,
                  CurrencyHelper.format(c.statementBalance, compact: false),
          ...
          sliver: SliverList(
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                return _buildListItem(
                  i['name'] ?? 'Investment',
                  CurrencyHelper.format(i['amount'], compact: false),
                  i['type'] ?? 'Equity',
                  semantic.income,
                );
              },
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            CurrencyHelper.format(amount.toInt(), compact: false),
            style: TextStyle(
              color: color,
              fontSize: 32,
